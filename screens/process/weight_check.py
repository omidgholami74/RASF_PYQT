from PyQt6.QtWidgets import QWidget, QVBoxLayout, QHBoxLayout, QFrame, QLabel, QLineEdit, QPushButton, QTableView, QHeaderView, QCheckBox, QMessageBox
...
class WeightCheckFrame(QWidget):
    ...
    def setup_ui(self):
        ...
        new_weight_layout.setSpacing(5)
        ...
        self.new_weight_entry.setFixedWidth(100)
